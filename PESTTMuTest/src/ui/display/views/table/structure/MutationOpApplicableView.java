 ...
 * 
 */
public class MutationOpApplicableView extends AbstractTableViewer implements
		Observer {
	private Composite parent;
	private IWorkbenchPartSite site;
	private TableViewer opMutationApplTableViewer;

	public MutationOpApplicableView(Composite parent, IWorkbenchPartSite site) {
		this.parent = parent;
		this.site = site;
	...
	public void dispose() {
		...
		opMutationApplTableViewer.getControl().dispose();
	}
