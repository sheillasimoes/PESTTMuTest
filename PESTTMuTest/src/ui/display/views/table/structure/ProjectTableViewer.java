...
public class ProjectTableViewer extends AbstractTableViewer implements Observer {
	private Composite parent;
	private IWorkbenchPartSite site;
	private TableViewer projectTableViewer;

	public ProjectTableViewer(Composite parent, IWorkbenchPartSite site) {
		this.parent = parent;
		this.site = site;
		Activator.getDefault().getProjectController()
				.addObserverCopyProject(this);
	}
	...
	public void update(Observable arg0, Object arg1) {
		List<String> list = Activator.getDefault().getProjectController()
				.getProjectNames();
	...
	public void dispose() {
		Activator.getDefault().getProjectController()
				.deleteObserverCopyProject(this);
	}
